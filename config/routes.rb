Paginadocumentos::Application.routes.draw do
  ...
  #############################3
   match '/jeunes/videos'=> 'jeunes#videos'
  ...
  ###################################################
   match '/femmes/videos'=> 'femmes#videos'
  match '/femmes/biblioteca'=> 'femmes#biblioteca'
  ...
  ################################################
  match 'asociation/videos/' => 'asociation#videos'
  ...
  match 'asociation/protagonistas'=> 'asociation#protagonistas'
  match 'asociation/pagina'=> 'asociation#pagina'
   match 'asociation/vision'=> 'asociation#vision'
  match 'asociation/colaborador'=> 'asociation#colaborador'
  match 'asociation/colaborador_a'=> 'asociation#colaborador_aportan'
  match 'asociation/colaborador_n'=> 'asociation#colaborador_no_aportan'
